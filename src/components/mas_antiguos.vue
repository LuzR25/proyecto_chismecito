<template>
    <div v-for="(item) in listaChismesAntiguos">
...
import { listaChismes, ordenarChismesAntiguos } from "../chismes_controller";
import { obtenerUsuario } from "../datos_controller";

let listaChismesAntiguos = reactive([]);

listaChismesAntiguos = ordenarChismesAntiguos();

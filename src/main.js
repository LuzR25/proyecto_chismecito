...
let request = indexedDB.open("ChismecitoDB", 1);
...
request.onupgradeneeded = function (event) {
    ...
    let usuarioStore = db.createObjectStore("Usuario", { keyPath: "idUsuario", autoIncrement: true });
    ...
    let chismeStore = db.createObjectStore("Chisme", { keyPath: "idChisme", autoIncrement: true });
